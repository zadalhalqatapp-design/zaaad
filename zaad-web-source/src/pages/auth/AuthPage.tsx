      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary-900 text-white flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative space-y-6">
          ...
          <p className="text-primary-100 text-lg leading-loose">
            حفظ يومي منظّم — مع الشرح والصوت والفيديو وصورة توضيحية لكل حديث، ومتابعة الإنجاز وإصدار الشهادات.
          </p>
            ...
            {mode === 'login' ? (
              ...
              <form onSubmit={handleRegister} className="space-y-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-on-surface-variant">يُستخدم لصياغة الدعاء في شهادتك بالصيغة الصحيحة.</p>
                </div>
                <Input
