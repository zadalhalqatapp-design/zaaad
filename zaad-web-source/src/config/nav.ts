...
import {
  ...
  ShieldCheck, BookMarked, CalendarDays, FolderOpen, UserCog, UserPlus, Library,
} from 'lucide-react';
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'إصدار الشهادات', path: 'issue-certificates', icon: Award, roles: ['admin'] },
  ...
  { label: 'إدارة الكتب', path: 'books', icon: Library, roles: ['admin'] },
